...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [146 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 14830352; uint32_t buffer_offset
	}, ; 143: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22368, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 15001872; uint32_t buffer_offset
	}, ; 144: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2106880, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 15024240; uint32_t buffer_offset
	} ; 145: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 17131120, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [17131120 x i8] zeroinitializer, align 1
