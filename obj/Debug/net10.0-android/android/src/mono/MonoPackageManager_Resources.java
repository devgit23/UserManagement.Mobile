...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "UserManagement.Mobile.dll" comes first in this list. */
		"UserManagement.Mobile.dll",
		...
		"UserManagement.Mobile.Core.dll",
		"UserManagement.Shared.dll",
