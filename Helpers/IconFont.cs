namespace UserManagement.Mobile.Helpers;

/// <summary>
/// Material Design Icons glyph constants for use in XAML and code.
/// Font family alias: "MaterialDesignIcons"
/// </summary>
public static class IconFont
{
    // --- Navigation / Tabs ---
    public const string ViewDashboard = "\U000F00E3";
    ...
    // --- Auth / Login ---
    public const string ShieldLockOutline = "\U000F0CC5";
    ...
    public const string CalendarClock = "\U000F00EE";
    public const string CheckCircle = "\U000F05E0";
    public const string ClipboardTextOutline = "\U000F0A6F";
    public const string ChevronRight = "\U000F0142";

    // --- Attendance ---
    public const string TimerOutline = "\U000F13AB";
    public const string ClockStart = "\U000F0155";
    public const string ClockEnd = "\U000F0151";
    public const string History = "\U000F02DA";
    public const string ClockCheckOutline = "\U000F0FA8";
    public const string ClockAlertOutline = "\U000F05CE";

    // --- Leave ---
    public const string CalendarRemove = "\U000F00F3";
    public const string CalendarPlus = "\U000F00F2";
    ...
    public const string BadgeAccountOutline = "\U000F0DB4";
    public const string OfficeBuildingOutline = "\U000F0990";

    // --- Profile ---
    public const string BriefcaseOutline = "\U000F0814";
    public const string PhoneOutline = "\U000F0DF2";
    ...
    public const string MapMarkerOutline = "\U000F037F";

    // --- Notifications ---
    public const string Bell = "\U000F009A";
    public const string BellBadge = "\U000F0178";
    ...
    public const string MinusCircle = "\U000F037A";
    public const string ProgressClock = "\U000F0966";
